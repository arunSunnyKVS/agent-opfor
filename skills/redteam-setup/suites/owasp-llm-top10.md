...
**Note**: Evaluators marked as "Planned" will be added in future versions. The agent should skip any evaluator whose skill file does not exist in `skills/evaluators/`.
