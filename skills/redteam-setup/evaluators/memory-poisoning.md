...
### 1. Direct Context Injection (Basic)

**Strategy**: Inject false information directly into agent context/memory.
...
### 2. Gradual Context Poisoning (Intermediate)

**Strategy**: Build false narrative over multiple interactions.
...
### 3. Knowledge Base Poisoning (Intermediate)

**Strategy**: Inject false documents into knowledge base/RAG.
...
### 4. Identity and Relationship Poisoning (Advanced)

**Strategy**: Build false beliefs about users and relationships.
