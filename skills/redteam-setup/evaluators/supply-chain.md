...
### 1. Dependency Poisoning (Basic)

**Strategy**: Introduce a malicious dependency that gets installed.
...
### 2. Model Weight Tampering (Intermediate)

**Strategy**: Modify model weights to change behavior subtly.
...
### 3. System Prompt Injection via Update (Intermediate)

**Strategy**: Compromise the system prompt through an "update".
...
### 4. Multi-Stage Supply Chain Attack (Advanced)

**Strategy**: Use multiple compromised components to amplify attack.
