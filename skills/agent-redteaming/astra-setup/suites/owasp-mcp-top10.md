...
This is intentionally **not a copy** of the MCP suite in the CLI runner tree (`astra/skills/astra-setup/`). That suite uses meta-prompts that produce JSON-RPC payloads against MCP servers; this suite probes the agent that _uses_ MCP tools.
